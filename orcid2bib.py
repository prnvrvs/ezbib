...
def build_parser():
    epilog_text = chr(10).join([
        ...
        "",
        "  5. Print simple formatted bibliography in APA, Nature, IEEE, or ACS style:",
        ...
        "     python3 scripts/orcid2bib.py 10.1016/j.actamat.2025.121319 -f text --style acs",
        "",
    ...
    parser.add_argument("-s", "--style", default="apa", help="Citation style for text format: apa (default), nature, ieee, acs, elsevier, chicago, harvard, springer, mla")

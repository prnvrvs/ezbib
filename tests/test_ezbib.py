...
class TestSanitizeLatex(unittest.TestCase):
    def test_mathml_conversion(self):
        ...
        self.assertEqual(ezbib.sanitize_latex(sample), expected)
    ...
    def test_empty_none(self):
        self.assertEqual(ezbib.sanitize_latex(None), "")
        self.assertEqual(ezbib.sanitize_latex(""), "")
...
class TestBibtexFormatting(unittest.TestCase):
  ...
  doi = {10.1016/j.actamat.2024.100000}
        ...
        formatted = ezbib.pretty_format_bibtex(raw_bib, extra_keywords="quality_assured")
...
class TestDoiDetection(unittest.TestCase):
    def test_bare_doi(self):
        ...
        self.assertTrue(ezbib.is_doi(" 10.1038/s41563-024-00000-x "))

    def test_url_doi(self):
        self.assertTrue(ezbib.is_doi("https://doi.org/10.1016/j.actamat.2025.121319"))
        self.assertTrue(ezbib.is_doi("http://dx.doi.org/10.1016/j.actamat.2025.121319"))

    def test_doi_with_parentheses(self):
        self.assertTrue(ezbib.is_doi("10.1016/S1359-6454(02)00577-3"))
        self.assertTrue(ezbib.is_doi("https://doi.org/10.1016/S1359-6454(02)00577-3"))
        self.assertEqual(
            ezbib.clean_doi_str("https://doi.org/10.1016/S1359-6454(02)00577-3"),
            "10.1016/S1359-6454(02)00577-3",
        )
        self.assertEqual(
            ezbib.clean_doi_str("doi: 10.1016/S1359-6454(02)00577-3."),
            "10.1016/S1359-6454(02)00577-3",
        )
